...
- **DONE:** Create redirect mechanism for renamed or merged articles to maintain link integrity. Implemented using `redirect_from` front matter field and static HTML redirect generation.
