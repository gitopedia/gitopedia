---
id: 01KBQ7PZW81JPJW8S5V9H846V2
slug: "james-webb-space-telescope--universewatcher-com-7"
title: "Source: James Webb Mission Timeline - Universe Watcher"
url: "https://universewatcher.com/james-webb-mission-timeline/"
type: source
related_article: "james-webb-space-telescope"
created: 2025-12-05T12:29:16Z
tags: ["topic:infrared-astronomy", "topic:star-formation", "topic:galaxy-assembly", "topic:exoplanet-atmospheres", "topic:smacs-0723", "topic:southern-ring-nebula", "topic:stephans-quintet", "topic:wasp-96-b", "topic:gravitational-lensing", "topic:remote-diagnostics", "topic:thermal-management", "topic:james-webb-space-telescope"]
people: ["person:riccardo-giacconi", "person:dan-goldin", "person:g.-illingworth"]
orgs: ["org:james-webb-space-telescope-1", "org:nasa", "org:european-space-agency-1", "org:canadian-space-agency", "org:space-telescope-science-institute", "org:hubble-space-telescope", "org:ariane-5"]
...
- Planet Expand child menu Earth Mars Jupiter Mercury Venus Moon Expand child menu Moon Phases Saturn Neptune Uranus

- Moon Expand child menu Moon Phases

- Stars Expand child menu Constellation

- James Webb Mission Timeline

- Early Development of JWST

- The James Webb Space Telescope's origins trace back to the Space Telescope Science Institute in the late 1980s.
- Inspired by Riccardo Giacconi's challenge, scientists envisioned a successor to the Hubble Space Telescope that could observe infrared light.
- A 1989 workshop, "The Next Generation: A 10 m Class UV-Visible-IR Successor to HST," laid the groundwork for this ambitious project.
...
- The project, initially named the Next Generation Space Telescope, faced significant engineering challenges. These included:
...
- The deployment of the massive sunshield

- The unfolding of the primary mirror

- The sunshield, spanning the size of a tennis court, required 178 release mechanisms and 50 major deployments. The 18 gold-coated segments of the primary mirror had to align with nanometer-level precision.

- Each step in this process showcased the collaborative effort between NASA, ESA, and CSA, highlighting the innovative engineering required for such an ambitious space observatory.

- Mission Objectives and First Images

- The James Webb Space Telescope aims to explore four main scientific areas:

- Detecting the first light and reionization

- Understanding galaxy assembly

- Exploring star and planet formation

- Investigating planetary systems for potential origins of life
...
- JWST's long-term prospects extend beyond immediate observations.
- Its data has the potential to advance astrophysics significantly, offering insights into early galaxy formation and exoplanet atmospheres.
- By addressing its operational concerns, JWST optimizes its scientific yield and paves the way for future cosmic exploration.

- The James Webb Space Telescope continues to expand our understanding of the universe, promising new discoveries that will reshape our knowledge of cosmic origins and evolution.
...
- The James Webb Space Telescope, also identified as Hubble's successor, launched this week.
- Although it was not scheduled to be placed into operation until 2018, the launch was significant for scientists and space enthusiasts alike.
- The telescope will cost a total of $8.7 billion and expects to last over ten…

- Telescopes are used to study space and the incidents occurring in space. Many astronomers also used in ancient times to study stars and outer space. Space is a magical world that has no limit or boundary. Every time, there's a new thing and a new phenomenon. Many stars and planets…

- In "Space Exploration"

- The James Webb Telescope, scheduled to launch in 2018, is already one of the most complex scientific instruments ever constructed by man, and it will need to capture thousands of images of some of the most distant phenomena in our universe before its mission ends in 2028. In order to…
