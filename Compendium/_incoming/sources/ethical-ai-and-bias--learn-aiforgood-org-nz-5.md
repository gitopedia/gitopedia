---
id: 01KBC9CJ4HP74H564VWNY5HESK
slug: "ethical-ai-and-bias--learn-aiforgood-org-nz-5"
title: "Source: Understanding Bias in AI and Machine Learning | AI Foundations"
url: "https://learn.aiforgood.org.nz/aifoundations/ai-bias"
type: source
related_article: "ethical-ai-and-bias"
created: 2025-12-01
tags: ["topic:ai-bias", "topic:fairness-in-ai", "topic:demographic-parity", "topic:equalized-odds", "topic:calibration", "topic:individual-fairness", "topic:ethical-ai", "topic:bias-testing", "topic:fairness-metrics", "topic:fair-ai-development", "topic:legal-and-ethical-considerations-in-ai", "topic:anti-discrimination-laws", "topic:transparency-in-ai", "topic:accountability-in-ai", "topic:privacy-in-ai", "topic:weapons-of-math-destruction-(book-by-cathy-o’neil)", "topic:fairness-in-machine-learning-(book-by-solon-barocas,-moritz-hardt,-and-arvind-narayanan)", "topic:generative-ai", "topic:machine-learning-fundamentals", "topic:overfitting-and-underfitting", "topic:ai-for-beginners", "topic:generative-ai-for-beginners", "topic:ibm’s-ai-fairness-360-toolkit", "topic:ai-for-good-learning-hub", "topic:ethical-ai-and-bias"]
people: ["person:solon-barocas-(co-author,-'fairness-in-machine-learning')", "person:moritz-hardt-(co-author,-'fairness-in-machine-learning')", "person:arvind-narayanan-(co-author,-'fairness-in-machine-learning')", "person:cathy-o’neil-(author,-'weapons-of-math-destruction')"]
...
- Imagine an AI system used for hiring that consistently favors candidates from certain universities, or a medical diagnosis AI that performs poorly for certain ethnic groups.
- These scenarios highlight one of the most critical challenges in modern AI: bias.
- Understanding and addressing bias is essential for creating fair, ethical, and inclusive AI systems.

- AI bias refers to systematic errors or unfair discrimination in AI systems that consistently favor or discriminate against certain groups, individuals, or outcomes.
- It occurs when an AI model makes predictions or decisions that are systematically prejudiced due to erroneous assumptions in the machine learning process.
...
- AI for Good Learning Hub

- Empowering the next generation of AI professionals through world-class education and hands-on experience.

- Generative AI for Beginners

- AI for Good Collective

- hello@aiforgood.org.nz

- 2025 AI for Good (NZ). MIT License. Site designed with ❤️ by AI For Good (NZ) for AI learners worldwide.
